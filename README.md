This is a React + Vite e-commerce project where users can explore and buy houseplants 🪴. Built using functional components, React Router, and Redux Toolkit for cart functionality. Hosted live on Netlify.
